 ...
 *
 */
function bgb_repeatable_specs_meta_box_display() {
	global $post;

	$repeatable_fields = get_post_meta($post->ID, 'repeatable_spec_fields', true);

	wp_nonce_field( 'bgb_repeatable_specs_meta_box_nonce', 'bgb_repeatable_specs_meta_box_nonce' );
	?>
 ...
 *
 */
function bgb_repeatable_specs_meta_box_save($post_id) {
	if (!isset($_POST['bgb_repeatable_specs_meta_box_nonce'])
		|| !wp_verify_nonce($_POST['bgb_repeatable_specs_meta_box_nonce'], 'bgb_repeatable_specs_meta_box_nonce')) {
		return;
	}
...
add_action('save_post', 'bgb_repeatable_specs_meta_box_save');
