 ...
 *
 */
function bgb_call_to_action_button_meta_box_display() {
	global $post;
	...
	wp_nonce_field( 'bgb_cta_button_meta_box_nonce', 'bgb_cta_button_meta_box_nonce' );
	?>
 ...
 *
 */
function bgb_call_to_action_button_meta_box_save($post_id) {
	if (!isset($_POST['bgb_cta_button_meta_box_nonce'])
		|| !wp_verify_nonce($_POST['bgb_call_to_action_button_meta_box_nonce'], 'bgb_call_to_action_button_meta_box_nonce')) {
		return;
	}
...
add_action('save_post', 'bgb_call_to_action_button_meta_box_save');
